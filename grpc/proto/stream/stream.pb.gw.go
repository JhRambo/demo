...
func local_request_StreamHttp_UploadFile_0(ctx context.Context, marshaler runtime.Marshaler, server StreamHttpServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq FileChunk
	var metadata runtime.ServerMetadata
...
func RegisterStreamHttpHandlerServer(ctx context.Context, mux *runtime.ServeMux, server StreamHttpServer) error {
	...
	mux.Handle("POST", pattern_StreamHttp_UploadFile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/.StreamHttp/UploadFile", runtime.WithHTTPPathPattern("/uploadfile"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_StreamHttp_UploadFile_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_StreamHttp_UploadFile_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterStreamHttpHandlerClient(ctx context.Context, mux *runtime.ServeMux, client StreamHttpClient) error {
	...
	mux.Handle("POST", pattern_StreamHttp_UploadFile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.StreamHttp/UploadFile", runtime.WithHTTPPathPattern("/uploadfile"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_StreamHttp_UploadFile_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_StreamHttp_UploadFile_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"uploadfile"}, ""))
)
