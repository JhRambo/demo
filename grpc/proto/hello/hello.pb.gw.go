...
func RegisterHelloHttpHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HelloHttpServer) error {
	...
	mux.Handle("POST", pattern_HelloHttp_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/.HelloHttp/SayHello", runtime.WithHTTPPathPattern("/hello"))
		if err != nil {
...
func RegisterHelloHttpHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HelloHttpClient) error {
	...
	mux.Handle("POST", pattern_HelloHttp_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.HelloHttp/SayHello", runtime.WithHTTPPathPattern("/hello"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_HelloHttp_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"hello"}, ""))
)
